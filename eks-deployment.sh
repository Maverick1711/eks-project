...
# Cluster variables
REGION="us-east-1"
CLUSTER_NAME="dev-shopwise-eks-cluster"
AWS_ACCOUNT_ID="521725812311"

# Namespace
NAMESPACE="dev-shopwise-eks-namespace"

# Service account variables
SERVICE_ACCOUNT_NAME="dev-shopwise-eks-service-account"
SECRET_MANAGER_ACCESS_POLICY_NAME="dev-policy-secrets-manager"
